...
def custom_score(game, player):
    ...
    return my_moves - 2 * opponent_moves # heuristic evaluation
...
def custom_score_2(game, player):
    ...
    my_moves = float(len(game.get_legal_moves(player)))
    opponent_moves = float(len(game.get_legal_moves(game.get_opponent(player))))
    return 2 * my_moves - opponent_moves # heuristic evaluation
...
def custom_score_3(game, player):
    ...
    center = float((h - y1) ** 2 + (w - x1) ** 2)
    return my_moves - opponent_moves + center # heuristic evaluation
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        # TODO: finish this function!
        if depth < 1:
            print("Depth is an integer at least 1!")
    ...
    def min_value(self, game, depth):
        """
        Return the minimal score of all possible child notes
        """
        if self.time_left() < self.TIMER_THRESHOLD:
            raise SearchTimeout()
        if depth == 0:
    ...
    def max_value(self, game, depth):
        """
        Return the maximal score of all possible child notes
        """
        if self.time_left() < self.TIMER_THRESHOLD:
            raise SearchTimeout()
        if depth == 0:
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def min_value(self, game, depth, alpha, beta):
        ...
        :param alpha:
        :param beta:
        :return: minimal values of child nodes left after alpha beta pruning
        """
        if self.time_left() < self.TIMER_THRESHOLD:
            raise SearchTimeout()
    ...
    def max_value(self, game, depth, alpha, beta):
        ...
        :param alpha:
        :param beta:
        :return: maximal values of child nodes left after alpha beta pruning
        """
        if self.time_left() < self.TIMER_THRESHOLD:
            raise SearchTimeout()
